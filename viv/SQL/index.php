...
<body class="va-l-page va-l-page--homepage">
    ...
    <div class="va-l-container">
        <main class="va-l-page-content">
            <?php
                // pripremamo upit
                $sql = "SELECT id, title, content, created_at, teaser FROM posts LIMIT 3";
            ...
            ?>
                    <article class="va-c-article">
                        <header>
                            ...
                            <div class="va-c-article__meta"><?php echo((new DateTime($post['created_at']))->format('d.m.Y')) ?> by John Doe</div>
                        </header>
                        <div>
